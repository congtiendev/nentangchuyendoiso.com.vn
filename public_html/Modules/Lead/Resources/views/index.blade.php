...
<script src="{{ asset('Modules/Lead/Resources/assets/js/main.min.js') }}"></script>
    ...
    <script>
        ...
        if (curHr < 12) {
            target.innerHTML = "{{ __('Chào buổi sáng,') }}";
        } else if (curHr < 17) {
            target.innerHTML = "{{ __('Chào buổi chiều,') }}";
        } else {
            target.innerHTML = "{{ __('Chào buổi tối,') }}";
        }
    </script>
                    ...
                    @if(isset($arrCount['client']))
                        ...
                        <div class="card dash1-card">
                            <div class="card-body mb-2">
                                ...
                                <p class="text-muted text-m mt-4 mb-4">{{ __('Tổng khách hàng') }}</p>
                        ...
                        <div class="{{ $class }} col-6">
                            <div class="card dash1-card">
                                <div class="card-body mb-2">
                                    ...
                                    <p class="text-muted text-m mt-4 mb-4">{{ __('Tổng số giao dịch') }}</p>
                        ...
                        <div class="{{ $class }} col-6">
                            <div class="card dash1-card">
                                <div class="card-body mb-2">
                                    ...
                                    <p class="text-muted text-m mt-4 mb-4">{{ __('Nhiệm vụ') }}</p>
            ...
            <div class="col-xxl-5">
                ...
                @if(!empty($chartcall))
                        <div class="card">
                            <div class="card-header ">
                                @if(\Auth::user()->type != 'super admin')
                                <h5>{{__('Giao dịch cuộc gọi theo ngày')}}</h5>
                                @endif
                            </div>
                            <div class="card-body p-2">
                ...
                @if(!empty($dealStageData))
                    ...
                    <div class="card">
                        <div class="card-header ">
                            <h5>{{__('Ưu đãi theo giao đoạn')}}</h5>
                        </div>
                        <div class="card-body p-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('Ưu đãi được sửa đổi gần đây') }}</h5>
                    </div>
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table">
