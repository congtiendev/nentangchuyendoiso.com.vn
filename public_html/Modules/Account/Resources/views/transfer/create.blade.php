    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('from_account', $bankAccount,null, array('class' => 'form-control ','required'=>'required','placeholder' => 'Chọn tài khoản')) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('to_account', __('To Account'),['class'=>'form-label']) }}
                {{ Form::select('to_account', $bankAccount,null, array('class' => 'form-control ','required'=>'required','placeholder' => 'Chọn tài khoản')) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('reference', '', array('class' => 'form-control','placeholder' => 'Thẩm quyền giải quyết')) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
