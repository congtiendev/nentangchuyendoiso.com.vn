        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('name',!empty($user->name) ? $user->name : null,array('class'=>'form-control','required'=>'required','placeholder' => __('Tên khách hàng')))}}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('contact',!empty($user->mobile_no) ? $user->mobile_no : null,array('class'=>'form-control','required'=>'required','placeholder' => __('Liên hệ') ))}}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('tax_number',null,array('class'=>'form-control','placeholder' => __('Số tax')))}}
                </div>
            </div>
        </div>
