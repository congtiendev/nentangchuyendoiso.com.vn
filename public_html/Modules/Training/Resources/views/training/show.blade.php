                        ...
                        <div class="row col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::select('performance', array_map('__', $performance) , null, ['class' => 'form-control ', 'placeholder' => __('Select Performance')]) }}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('status', __('Status'), ['class' => 'col-form-label text-dark']) }}
                                    {{ Form::select('status',array_map('__', $status) , null, ['class' => 'form-control ', 'placeholder' => __('Select Status')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="row col-md-12">
