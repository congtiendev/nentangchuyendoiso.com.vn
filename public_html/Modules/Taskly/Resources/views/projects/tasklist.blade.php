                                            ...
                                            @if(Laratrust::hasPermission('task show') || Laratrust::hasPermission('task edit') || Laratrust::hasPermission('task delete'))
                                                <td class="text-end">
                                                    ...
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a data-size="lg" data-url="{{ route('tasks.show', [$task->project_id, $task->id]) }}" data-bs-toggle="tooltip" title="{{__('Hiển thị thông tin công việc')}}" data-ajax-popup="true" data-title="{{__('View')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </div>
                                                    @endpermission
                                                    ...
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#!" class="btn btn-sm   align-items-center text-white show_confirm" data-bs-toggle="tooltip" title='Xóa công việc được chọn'>
