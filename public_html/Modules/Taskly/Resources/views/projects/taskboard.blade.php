...
@section('page-breadcrumb')
    {{ __('Project') }},{{ __('Project Details') }},{{ __('Công việc') }}
@endsection
@section('page-action')
    <div>
        @stack('addButtonHook')
        ...
        @permission('task create')
            <a class="btn btn-sm btn-primary text-white" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Task') }}"
                data-url="{{ route('tasks.create', [$project->id]) }}" data-toggle="tooltip" title="{{ __('Tạo nguồn gốc công việc') }}"><i
                    class="ti ti-plus"></i>Tạo nguồn gốc công việc</a>
        @endpermission
        @permission('task create')
            <a class="btn btn-sm btn-primary text-white" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Task') }}"
                data-url="{{ route('tasks.create', [$project->id]) }}" data-toggle="tooltip" title="{{ __('Tạo liên kết điều kiện') }}"><i
                    class="ti ti-plus"></i>Tạo liên kết điều kiện</a>
        @endpermission
        @permission('task create')
            <a class="btn btn-sm btn-primary text-white" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Task') }}"
                data-url="{{ route('tasks.create', [$project->id]) }}" data-toggle="tooltip" title="{{ __('Tạo công việc từ danh sách') }}"><i
                    class="ti ti-plus"></i>Tạo công việc từ danh sách</a>
        @endpermission
                                                            ...
                                                            @permission('task show')
                                                                <a class="dropdown-item" data-ajax-popup="true" data-size="lg"
                                                                    ...
                                                                    data-url="{{ route('tasks.show', [$task->project_id, $task->id]) }}"><i
                                                                        class="ti ti-eye"></i> {{ __('Hiện thị thông tin') }}</a>
                                                            @endpermission
                                                            @permission('task edit')
                                                                <a class="dropdown-item" data-ajax-popup="true" data-size="lg"
                                                                    data-title="{{ __('Edit Task') }}"data-url="{{ route('tasks.edit', [$task->project_id, $task->id]) }}"><i
                                                                        class="ti ti-pencil"></i> {{ __('Sửa thông tin chung') }}</a>
                                                            @endpermission
                                                             @permission('task edit')
                                                                <a class="dropdown-item" data-ajax-popup="true" data-size="lg"
                                                                    data-title="{{ __('Edit Task') }}"data-url="{{ route('tasks.edit', [$task->project_id, $task->id]) }}"><i
                                                                        class="ti ti-pencil"></i> {{ __('Sửa nguồn gốc công việc') }}</a>
                                                            @endpermission
