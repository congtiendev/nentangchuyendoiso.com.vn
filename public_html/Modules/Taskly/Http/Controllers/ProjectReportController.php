    ...
    public function index(Request $request)
    {
       ...
       foreach($projects as $project) {
         ...
         if ($project->status == 'Finished') {
               $tmp['status'] = '<span class="badge rounded-pill p-2 px-3  bg-success">' .'Hoàn thành' . '</span>';
           }
           elseif($project->status == 'Ongoing') {
               $tmp['status'] = '<span class="badge rounded-pill p-2 px-3  bg-secondary">' . 'Đang thực hiện' . '</span>';
           }
           else {
               $tmp['status'] = '<span class="badge rounded-pill p-2 px-3  bg-warning">' . 'Đang chờ'. '</span>';
           }
