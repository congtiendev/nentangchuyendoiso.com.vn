...
@section('action-btn')
    <div>
        <a href="{{ route('contract.download.pdf', \Crypt::encrypt($contract->id)) }}" target="_blanks"
            class="btn btn-sm btn-primary py-2" title="{{ __('Download') }}" data-bs-toggle="tooltip" data-bs-placement="top"><i
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-sm-6 mb-3 mb-sm-0 mt-3">
                            <div class="mb-3">
                                ...
                                <span class="col-md-8"><span class="text-md">{{ $contract_type->name }}</span></span>
                            </div>
                            ...
                            <div>
                                <div class="float-end">
                                    <div class="">
                                        ...
                                        <span class="col-md-8"><span
                                                class="text-md">{{ company_date_formate($contract->created_at)}}</span></span>
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="d-inline-block m-0 d-print-none">{{ __('End Date   :') }}</h6>
                                        <span class="col-md-8"><span
                                                class="text-md">{{ company_date_formate($contract->updated_at) }}</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div>
                                ...
                                <div>
                                    <img width="150px" src="{{ url($contract->content) }}">
                                </div>
                        </div>
