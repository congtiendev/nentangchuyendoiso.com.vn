    ...
    <div class="row">
        ...
        @if (\Auth::user()->type == 'company')
            <div class="col-md-6 form-group">
                ...
                {{ Form::select('user_id',$user,null, array('class' => 'form-control','id'=>'user_id','placeholder' => 'Chọn người dùng','required'=>'required')) }}
            </div>
        @else
        ...
        @if(module_is_active('Taskly'))
            <div class="col-md-6 form-group">
                ...
                {{ Form::select('project_id',$project,null, array('class' => 'form-control','id'=>'project_id','placeholder' => 'Chọn công việc')) }}
            </div>
        @endif
        <div class="col-md-6 form-group">
