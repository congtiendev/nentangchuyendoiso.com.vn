...
@php
    $path = url("/Modules/CMMS/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('CmmsGo is the most convenient tool to manage your purchases, sales, and maintenance of the components, and parts along with outsourcing of the same following the location you are working. It makes the whole management of such a thing very transparent and usable.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{ __('Complete Maintenance Management System')}}</h2>
                <p>{{__('CMMS gives users deep insight into their maintenance needs with detailed work order schedules, reliable reports, dashboards, log times')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('CMMS makes it easy to manage work orders')}}</h2>
                        </div>
                        <p>{{__('Workorder Management Solution lets you improve the team’s time while completing the task and reduces the time you use to manage it. It helps you keep an eye on activities and keep you up to date with all the required information.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Esy to manage work orders')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('This tool gives you a central communication platform where teammates can share updates and documents with ease.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Easy to manage work request')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('This tool gives can manage user work request which is help to communicate with company and easily send to thier work requirement.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Most effective way to manage your preventive maintenance')}}</h2>
                        </div>
                        <p>{{__('A preventive maintenance solution makes sure that on an ongoing basis, maintenance can be scheduled automatically for assets, and equipment and allocated to a chosen contractor in a seamless and automated manner.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Manage preventive maintenance')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('A preventive Maintenance solution is the easiest way to keep your parts running smoothly and prevent downtime with a proactive schedule of machine')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Well-managed purchase orders')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('It helps you track how many orders you have placed for an item in a specific time period and with a specific supplier')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Manage several locations')}}</h2>
                        </div>
                        <p>{{__('CMMS with multiple locations greatly benefit from location management software as it provides centralized control and oversight. It allows businesses to effectively monitor and manage operations across all locations from a single platform')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Component maintenance operations')}}</h2>
                        </div>
                        <p>{{__('This report is for a single component and shows key data around who has worked on the Component , Associated documentation and images such as repair manuals and warranties')}}</p>
                    </div>
                </div>
            </div>
        </div>
