        ...
        <div class="row">
            ...
            @if($type == 'account')
                <div class="col-6">
                    <div class="form-group">
                        ...
                        {!!Form::select('account', $account_name, $id,array('class' => 'form-control','required'=>'required','placeholder'=>'Chọn tài khoản')) !!}
                    </div>
                </div>
            @else
                <div class="col-6">
                    <div class="form-group">
                        ...
                        {!!Form::select('account', $account_name, null,array('class' => 'form-control','required'=>'required','placeholder'=>'Chọn tài khoản')) !!}
                    </div>
                </div>
            @endif
            @if($type == 'contact')
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    {!!Form::select('stage', $opportunities_stage, null,array('class' => 'form-control','required'=>'required','placeholder'=>'Chọn giai đoạn cơ hội')) !!}
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
