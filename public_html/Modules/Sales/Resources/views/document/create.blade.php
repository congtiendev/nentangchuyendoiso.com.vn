    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {!!Form::select('folder', $folder, null,array('class' => 'form-control','required'=>'required' ,'placeholder' => __('Select Folder'))) !!}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {!!Form::select('status', array_map('__', $status), null,array('class' => 'form-control','required'=>'required' ,'placeholder' => __('Select Status'))) !!}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
