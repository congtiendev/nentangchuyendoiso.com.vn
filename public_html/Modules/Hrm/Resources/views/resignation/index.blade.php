...
<div>
    @permission('resignation create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Tạo mới nghỉ việc') }}" data-url="{{route('resignation.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
