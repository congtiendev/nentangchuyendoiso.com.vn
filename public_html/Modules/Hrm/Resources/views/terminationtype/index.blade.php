...
<div>
    @permission('terminationtype create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Tạo loại miễn nhiệm') }}" data-url="{{route('terminationtype.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
