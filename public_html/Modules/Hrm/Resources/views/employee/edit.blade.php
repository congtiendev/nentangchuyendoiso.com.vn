...
<div class="row">
    <div class="">
        <div class="">
            @if(!empty($employee))
            {{ Form::model($employee, ['route' => ['employee.update', $employee->id], 'method' => 'PUT', 'enctype' =>
            'multipart/form-data']) }}
            @else
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('name',!empty($user->name) ? $user->name : '', ['class' =>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        'required','placeholder'=>"Select Date of Birth",'max'=>date('Y-m-d')]) !!}
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group ">
                                        ...
                                        <div class="d-flex radio-check">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="g_male" value="Male" name="gender"
                                                    class="form-check-input" {{!empty($employee)? $employee->gender ==
                                                'Male' ? 'checked' : '' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="preview-container mt-2">
                                        ...
                                        <img id="previewCertificate"
                                            src="@if(!empty($employee->certificate)){{ url($employee->certificate) }}@else https://phutungnhapkhauchinhhang.com/wp-content/uploads/2020/06/default-thumbnail.jpg @endif"
                                            alt="Preview" style="max-width: 100%; max-height: 110px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="choose-files">
                                        <label for="military_politics">
                                            ...
                                            <input type="file" name="military_politics" id="military_politics"
                                                data-filename="military_politics" class="form-control file  d-none">
                                        </label>
                                    </div>
                                    <div class="preview-container mt-2">
                                        <img id="previewMilitaryPolitics"
                                            src="@if(!empty($employee->military_politics)){{ url($employee->military_politics) }}@else https://phutungnhapkhauchinhhang.com/wp-content/uploads/2020/06/default-thumbnail.jpg @endif"
                                            alt="Preview" style="max-width: 100%; max-height: 110px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="choose-files">
                                        <label for="health">
                                            ...
                                            <input type="file" name="health" id="health" data-filename="health"
                                                class="form-control file  d-none">
                                        </label>
                                    </div>
                                    <div class="preview-container mt-2">
                                        <img id="previewHealth"
                                            src="@if(!empty($employee->health)){{ url($employee->health) }}@else https://phutungnhapkhauchinhhang.com/wp-content/uploads/2020/06/default-thumbnail.jpg @endif"
                                            alt="Preview" style="max-width: 100%; max-height: 110px;">
                                    </div>
                                </div>
                            ...
                            {!! Form::submit('Update', ['class' => 'btn-create btn-xs badge-blue radius-10px
                            float-right']) !!}
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    => 'required', 'placeholder' => __('Select
                                    '.(!empty($company_settings['hrm_branch_name']) ?
                                    $company_settings['hrm_branch_name'] : __('select Branch')))]) }}
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    => 'department_id', 'required' => 'required','placeholder' => __('Select
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    'id' => 'designation_id', 'required' => 'required','placeholder' => __('Select
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    'required','placeholder'=>"Select Date Of Joining"]) !!}
                                </div>
                                @if(module_is_active('CustomField') && !$customFields->isEmpty())
                                <div class="col-md-12">
                                    <div class="tab-pane fade show" id="tab-2" role="tabpanel">
                                        @include('customfield::formBuilder', ['fildedata' =>
                                        isset($employee->customField) ? $employee->customField : ''])
                                    </div>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="card em-card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info">
                                            <strong>{{ !empty($company_settings['hrm_branch_name']) ?
                                                $company_settings['hrm_branch_name'] : __('Branch') }}</strong>
                                            <span>{{ !empty($employee->branch) ? $employee->branch->name : '' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info font-style">
                                            <strong>{{ !empty($company_settings['hrm_department_name']) ?
                                                $company_settings['hrm_department_name'] : __('Department') }}</strong>
                                            <span>{{ !empty($employee->department) ? $employee->department->name : ''
                                                }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info font-style">
                                            <strong>{{ !empty($company_settings['hrm_designation_name']) ?
                                                $company_settings['hrm_designation_name'] : __('Designation')
                                                }}</strong>
                                            <span>{{ !empty($employee->designation) ? $employee->designation->name : ''
                                                }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group col-12 d-flex">
                                    ...
                                    <div class="float-right col-8">
                                        ...
                                        @php
                                        $employeedoc =
                                        !empty($employee->documents)?$employee->documents()->pluck('document_value','document_id'):[];
                                        @endphp
                                        <div class="choose-files">
                                            <label for="document[{{ $document->id }}]">
                                                <div class=" bg-primary "> <i class="ti ti-upload px-1"></i>{{
                                                    __('Choose file here') }}</div>
                                                <input type="file" class="form-control file" data-filename="documents"
                                                    @error('document') is-invalid @enderror @if ($document->is_required
                                                == 1) @endif name="document[{{ $document->id }}]" id="document[{{
                                                $document->id }}]"
                                    ...
                                    <div class="col-md-12">
                                        <div class="info">
                                            ...
                                            <span><a href="{{ !empty($employeedoc[$document->id]) ? asset(Storage::url('uploads/document')) . '/' . $employeedoc[$document->id] : '' }}"
                                                    target="_blank">{{ !empty($employeedoc[$document->id]) ?
                                                    $employeedoc[$document->id] : '' }}</a></span>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
