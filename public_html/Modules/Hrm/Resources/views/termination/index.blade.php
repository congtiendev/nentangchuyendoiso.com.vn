...
<div>
    @permission('termination create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Tạo mới miễn nhiệm') }}" data-url="{{route('termination.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
                        ...
                        <thead>
                            <tr>
                                @if (in_array(\Auth::user()->type, \Auth::user()->not_emp_type))
                                    <th>{{ __('Employee') }}</th>
                                @endif
                                <th>{{ __('Loại miễn nhiệm') }}</th>
                                <th>{{ __('Notice Date') }}</th>
                                <th>{{ __('Ngày miễn nhiệm') }}</th>
