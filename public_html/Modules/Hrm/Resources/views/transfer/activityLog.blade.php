...
<div>
    @permission('employee create')
        <a href="{{ route('transfer.index') }}" data-title="{{ __('Lịch sử chỉnh sửa') }}" data-bs-toggle="tooltip"
                                ...
                                @foreach ($transfers as $log)
                                       ...
                                       <tr>
                                            ...
                                            @if($log->action_type == 'store')
                                                <td>
                                                    @foreach($changes as $field => $change)
                                                    Đã tạo điều chuyển đến chi nhánh 
                                                    <strong>{{$change['branchName']}}</strong>
                                                    Phòng 
                                                    <strong>{{$change['departmentName']}}</strong>
                                                    cho nhân viên 
