...
@section('page-title')
    {{ __('Quản lí điều chuyển') }}
@endsection
@section('page-breadcrumb')
{{ __('Điều chuyển nhân sự') }}
@endsection
@section('page-action')
<div>
    @permission('transfer create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Tạo điều chuyển mới') }}" data-url="{{route('transfer.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
