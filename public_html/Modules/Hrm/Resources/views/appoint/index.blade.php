                                                        ...
                                                        <span>
                                                            @permission('employee edit')
                                                                <div class="action-btn bg-info ms-2">
                                                                    <a href="{{ route('appoint.edit', \Illuminate\Support\Facades\Crypt::encrypt($employee->ID)) }}"
                                                            ...
                                                            @if (!empty($employee->employee_id))
                                                                @permission('employee edit')
                                                                    <div class="action-btn bg-info ms-2">
                                                                        <a href="{{ route('appoint.create', \Illuminate\Support\Facades\Crypt::encrypt($employee->ID)) }}"
                                                                            class="mx-3 btn btn-sm btn-primary  align-items-center"
                                                                            data-bs-toggle="tooltip" title=""
                                                                            data-bs-original-title="{{ __('Thêm') }}">
                                                                ...
                                                                @permission('employee show')
                                                                    <div class="action-btn bg-warning ms-2">
                                                                        <a href="{{ route('appoint.show', \Illuminate\Support\Facades\Crypt::encrypt($employee->id)) }}"
                                                                            class="mx-3 btn btn-sm  align-items-center"
                                                                            data-bs-toggle="tooltip" title=""
