{{ Form::open(['url' => 'procedures_type/store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('name', null, ['class' => 'form-control','required' => 'required', 'placeholder' => __('Nhập loại quy trình')]) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
