                          ...
                          <div class="card-body setting-card setting-logo-box p-3">
                              <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                  <div class="logo-content img-fluid logo-set-bg  text-center py-2">
                                    ...
                                    @endphp
                                      <img alt="image" src="{{ get_file($logo_dark)}}{{'?'.time()}}" class="small-logo" id="pre_default_logo">
                                  </div>
                          ...
                          <div class="card-body setting-card setting-logo-box p-3">
                              <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                  <div class="logo-content img-fluid logo-set-bg text-center py-2">
                                    ...
                                    @endphp
                                      <img alt="image" src="{{ get_file($logo_light) }}{{'?'.time()}}" class="img_setting small-logo" id="landing_page_logo">
                                  </div>
                                  <div class="choose-files mt-3">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3 col-12">
                    <div class="form-check form-switch mt-2">
                        <input type="checkbox" class="form-check-input" id="landing_page"
                            name="landing_page"
             ...
             <div class="row">
                <div class="col-2">
                   <div class="form-group col switch-width">
                      ...
                      <option value="1" {{ (isset($settings['currency_format']) && $settings['currency_format'] =='1')?'selected':'' }}>1.0</option>
                      <option value="2" {{ (isset($settings['currency_format']) && $settings['currency_format'] =='2')?'selected':'' }}>1.00</option>
                      <option value="3" {{ (isset($settings['currency_format']) && $settings['currency_format'] =='3')?'selected':'' }}>1.000</option>
                      <option value="4" {{ (isset($settings['currency_format']) && $settings['currency_format'] =='4')?'selected':'' }}>1.0000</option>
                      </select>
                   </div>
                </div>
                <div class="col-2">
                   <div class="form-group col switch-width">
                      ...
                      <option value="{{ $c->symbol }}-{{ $c->code }}" data-symbol="{{ $c->symbol }}" {{  (isset($settings['defult_currancy']) && $settings['defult_currancy'] == $c->code) ?'selected':'' }}>{{ $c->symbol }} - {{ $c->code }} </option>
                      @endforeach
                      </select>
                   </div>
                </div>
                 <div class="col-2">
                   <div class="form-group col switch-width">
                      ...
                      <option value="{{ $key }}" {{ (isset($settings['defult_language']) && $settings['defult_language'] == $key) ?'selected':'' }}>{{Str::ucfirst($language)}} </option>
                      @endforeach
                      </select>
                   </div>
                </div>
               <div class="col-sm-6 col-12">
                   ...
                   <div class="form-group">
                      ...
                      <div class="row ms-1">
                         <div class="form-check col-md-6">
                            <input class="form-check-input" type="radio" name="site_currency_symbol_position" value="pre" @if(!isset($settings['site_currency_symbol_position']) || $settings['site_currency_symbol_position'] == 'pre') checked @endif
                            id="flexCheckDefault">
                         ...
                         <div class="form-check col-md-6">
                            <input class="form-check-input" type="radio" name="site_currency_symbol_position" value="post" @if(isset($settings['site_currency_symbol_position']) && $settings['site_currency_symbol_position'] == 'post') checked @endif
                            id="flexCheckChecked">
                ...
                <div class="col-md-4">
                   <div class="form-group">
                      ...
                      <option value="d-m-Y" @if( isset($settings['site_date_format']) && $settings['site_date_format'] == 'd-m-Y') selected="selected" @endif>DD-MM-YYYY</option>
                      <option value="m-d-Y" @if( isset($settings['site_date_format']) && $settings['site_date_format'] == 'm-d-Y') selected="selected" @endif>MM-DD-YYYY</option>
                      <option value="Y-m-d" @if( isset($settings['site_date_format']) && $settings['site_date_format'] == 'Y-m-d') selected="selected" @endif>YYYY-MM-DD</option>
                      </select>
                   </div>
                </div>
                  <div class="col-md-4">
                   <div class="form-group">
                      ...
                      <option value="g:i A" @if( isset($settings['site_time_format']) && $settings['site_time_format'] == 'g:i A') selected="selected" @endif>10:30 PM</option>
                      <option value="H:i" @if( isset($settings['site_time_format']) && $settings['site_time_format'] == 'H:i') selected="selected" @endif>22:30</option>
                      </select>
                   </div>
                </div>
             </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{Form::text('pusher_app_id',!empty($settings['PUSHER_APP_ID']) ? $settings['PUSHER_APP_ID'] :null,array('class'=>'form-control font-style','required'=>'required','placeholder'=>'Enter Pusher App Id'))}}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {{Form::label('pusher_app_key',__('Pusher App Key'),array('class'=>'form-label')) }}
                        {{Form::text('pusher_app_key',!empty($settings['PUSHER_APP_KEY']) ? $settings['PUSHER_APP_KEY'] :null,array('class'=>'form-control font-style','required'=>'required','placeholder'=>'Enter Pusher App Key'))}}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{Form::text('pusher_app_secret',!empty($settings['PUSHER_APP_SECRET']) ? $settings['PUSHER_APP_SECRET'] :null,array('class'=>'form-control font-style','required'=>'required','placeholder'=>'Enter Pusher App Secret'))}}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {{Form::label('pusher_app_cluster',__('Pusher App Cluster'),array('class'=>'form-label')) }}
                        {{Form::text('pusher_app_cluster',!empty($settings['PUSHER_APP_CLUSTER']) ? $settings['PUSHER_APP_CLUSTER'] :null,array('class'=>'form-control font-style','required'=>'required','placeholder'=>'Enter Pusher App Cluster'))}}
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="card" id="storage-sidenav">
    ...
    <div class="card-body">
        <div class="d-flex">
            <div class="pe-2">
                <input type="radio" class="btn-check" name="storage_setting" id="local-outlined"
                    autocomplete="off" {{ (isset($settings['storage_setting']) && $settings['storage_setting'] == 'local') ? 'checked' : '' }}
                    value="local">
            ...
            <div class="pe-2">
                <input type="radio" class="btn-check" name="storage_setting" id="s3-outlined"
                    autocomplete="off" {{ (isset($settings['storage_setting']) &&  $settings['storage_setting'] == 's3') ? 'checked' : '' }} value="s3">
            ...
            <div class="pe-2">
                <input type="radio" class="btn-check" name="storage_setting" id="wasabi-outlined"
                    autocomplete="off" {{ (isset($settings['storage_setting']) &&  $settings['storage_setting'] == 'wasabi') ? 'checked' : '' }}
                    value="wasabi">
        ...
        <div class="s3-setting row {{ (isset($settings['storage_setting']) &&  $settings['storage_setting'] == 's3') ? ' ' : 'd-none' }}">
            ...
            <div class=" row ">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_key" class="form-control" value="{{ (isset($settings['s3_key'])) ? $settings['s3_key'] : null }}"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_secret" class="form-control" value="{{ (isset($settings['s3_secret'])) ? $settings['s3_secret'] : null }}"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_region" class="form-control" value="{{ (isset($settings['s3_region'])) ? $settings['s3_region'] : null }}"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_bucket" class="form-control" value="{{ (isset($settings['s3_bucket'])) ? $settings['s3_bucket'] : null }}"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_url" class="form-control" value="{{ (isset($settings['s3_url'])) ? $settings['s3_url'] : null }}"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="s3_endpoint" class="form-control" value="{{ (isset($settings['s3_endpoint'])) ? $settings['s3_endpoint'] : null }}"
                            placeholder="{{ __('S3 Bucket') }}">
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="wasabi-setting row {{ (isset($settings['storage_setting']) &&  $settings['storage_setting'] == 'wasabi') ? ' ' : 'd-none' }}">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="wasabi_key" class="form-control"
                            value="{{ isset($settings['wasabi_key']) ? $settings['wasabi_key'] : null }}" placeholder="{{ __('Wasabi Key') }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="wasabi_url" class="form-control"
                            value="{{ isset($settings['wasabi_url']) ? $settings['wasabi_url'] : null }}" placeholder="{{ __('Wasabi URL') }}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
...
@endphp
@if (in_array('AIAssistant',$activatedModules) || in_array('AIDocument',$activatedModules) || in_array('AIImage',$activatedModules))
    <script>
        $(document).ready(function(){
