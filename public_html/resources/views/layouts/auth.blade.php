...
<head>
    ...
    <title>@yield('page-title')
        | {{ !empty(admin_setting('title_text')) ? admin_setting('title_text') : config('app.name', 'WorkDo') }}</title>
...
<div class="custom-login">
    <div class="login-bg-img">
        ...
        <img src="{{ asset('images/bg_login.jpg') }}" class="login-bg-1 background-login">
    </div>
...
{{--                                 alt="{{ config('app.name', 'WorkDo') }}" class="navbar-brand-img auth-navbar-brand">--}}
{{--                        </a>--}}
{{--                    </div>--}}
