                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,!empty($invoice->user_id) ? $invoice->user_id : null, array('class' => 'form-control ','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required','placeholder' =>'Chọn khách hàng')) }}
                            </div>
