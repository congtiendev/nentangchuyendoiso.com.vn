                                    ...
                                    @if (module_is_active($module) || $module == 'General')
                                        <li class="nav-item" role="presentation">
                                            <button
                                                ...
                                                type="button">{{ lcfirst(__('role.' . Module_Alias_Name($module))) }}</button>
                                        </li>
                                    @endif
                                @endforeach
                            </ul>
                                                    ...
                                                    <tbody>
                                                     ...
                                                     @foreach ($module_list as  $list)
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::label('module_checkbox_'.$key.'_'.$list, lcfirst(__('role.' . $list)), ['class' => 'form-check-label pointer']) }}</td>
                                                            <td class="module_checkbox_{{$key}}_{{$list}}">
                                                                <div class="row">
                                                                    @foreach ($permissions as $key => $prermission)
                                                                        @php
                                                                            $check = strtok($prermission->name, " ");
                                                                            $name =$prermission->name;
                                                                        @endphp
                                                                        @if ($list == $check)
                                                                            <div class="col-lg-3 col-md-6 form-check mb-2">
                                                                                ...
                                                                                {{ Form::label('permission_' . $key . '_' . $prermission->id, lcfirst(__('role.' . $name)), ['class' => 'form-check-label']) }}
                                                                            </div>
                                                                        @endif
                                                                    @endforeach
                                                                </div>
