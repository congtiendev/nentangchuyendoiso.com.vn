                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                    ...
                                    {{ Form::select('customer_id', $customers,null, array('class' => 'form-control','id'=>'customer','data-url'=>route('proposal.customer'),'required'=>'required','placeholder'=>"Chọn khách hàng")) }}
                            </div>
