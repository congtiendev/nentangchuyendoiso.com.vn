...
@section('content')
                    ...
                    @if (\Auth::user()->type == 'company' && $proposal->status != 0)
                        <div class="all-button-box mx-2">
                            <a href="{{ route('proposal.resent', $proposal->id) }}"
                                class="btn btn-xs btn-primary btn-icon-only width-auto">{{ __('Gửi lại văn bản') }}</a>
                        </div>
                    @endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade active show" id="proposal" role="tabpanel" aria-labelledby="pills-user-tab-1">
                    <div class="card">
                        <div class="card-body">
                            <div class="invoice">
 ...
 --}}
                ...
                <div class="tab-pane fade " id="proposal-attechment" role="tabpanel" aria-labelledby="pills-user-tab-1">
                    <div class="row">
