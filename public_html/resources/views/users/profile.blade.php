                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 mb-3">
                                        <div class="form-group">
                                            <img src="{{ !empty($userDetail->avatar) ? get_file($userDetail->avatar) : get_file('uploads/users-avatar/avatar.png') }}"
                                                id="myAvatar" alt="user-image"
                                                class="rounded-circle img-thumbnail m-2 w-25">
                                            <div class="choose-files mt-3">
                                                <label for="avatar">
                                                    <div class=" bg-primary "> <i
                                                            class="ti ti-upload px-1"></i>{{ __('Tải ảnh đại diện') }}</div>
                                                    <input type="file"
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        <div class="form-group">
                                            <img src="{{ !empty($userDetail->sign_image) ? get_file($userDetail->sign_image) : get_file('uploads/users-avatar/avatar.png') }}"
                                                id="mySign" alt="sign-image" class="img-thumbnail m-2 w-25">
                                            <div class="choose-files mt-3">
                                                <label for="sign" class="text-center">
                                                    <div class=" bg-primary "> <i
                                                            class="ti ti-upload px-1"></i>{{ __('Tải chữ kí') }}</div>
                                                    <input type="file"
                                                        accept="image/png, image/gif, image/jpeg,  image/jpg"
                                                        class="form-control" name="sign_image" id="sign"
                                                        data-filename="sign-image">
                                                </label>
                                            </div>
                                            @error('sign_image')
                                                <span class="invalid-feedback" role="alert">
